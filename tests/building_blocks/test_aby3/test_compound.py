...
def run_tests(small=False):
    ...
    for ell in ells:
        ...
        # ——— multi-round: share→hadamard→add_vec→reveal ——
        nv2 = 8
        ...
        # ——— dot product as sum of hadamard ——————————
        nv3 = 16
        ...
        # ——— counters track over multiple rounds ———————
    ...
    # ——— ring_conv compound: conv then reveal ——————
