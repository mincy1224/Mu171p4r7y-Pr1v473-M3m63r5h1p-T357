...
def run_tests(small=False):
    ...
    # -- gen parameter validation (inside run_dpf) --
    ...
    for ei, eo in test_ei_eo:
        ...
        # Test gen rejects out-of-range alpha
        ...
        # Test gen accepts valid alpha=0 and alpha=mask
    ...
    for ei, eo in [(13, 2), (15, 6)] if not small else [(13, 2)]:
        ...
        # Wraparound: bg near top, ed near bottom
        bg = vl - 10
        ed = 9
        rlen = (vl - bg) + (ed + 1)  # = 20
    ...
    # -- eval multithreaded consistency -----------
    ei, eo = 13, 4
    vl = 1 << ei
    alpha = random.randint(0, vl - 1)
